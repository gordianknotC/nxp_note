...
Note over MProc: 1) each fakeActivity has several intentFilter<br>2) each fakeActivity map to a unique string action<br>__as
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkwMzg4NTY2MiwtMTQ1Mzg4MDAwOCwtMT
