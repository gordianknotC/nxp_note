...
Note over MProc,MAct: 1) instantiate all FakeActivity<br>2) setup intentFilters for each FakeActivity<br>.<br>in 2)<br>- setup inten 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMTkwNzc3ODksLTE0NTM4ODAwMDgsLT
